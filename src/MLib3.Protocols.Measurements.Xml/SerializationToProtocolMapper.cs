...
public static class SerializationToProtocolMapper
{
    public static IProtocol Map(Protocol protocol)
    {
    ...
    private static Measurements.Extensions? MapExtensions(Extensions? extensions)
    {
